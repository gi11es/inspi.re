...
$MEMCACHE['PREFIX'] = 'InspireDev-';
$MEMCACHE['PORT'] = 11211;

$MONGODB['SERVER'] = 'localhost';
$MONGODB['DATABASE'] = 'InspireDev';

$CURRENT_LOG_LEVEL = $LOG_LEVEL['TRACE'];
$LOG_TIME_FORMAT = 'Y-m-d H:i:s';
$LOG_FILE_PATH = '/home/daruma/devlogs/';
...
$DATABASE['NAME'] = 'daruma_inspiredev';
...
$AD_CODE['EDIT_PROFILE'] = array('ID' => '8186924905', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['THEME_LIST'] = array('ID' => '6792600618', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 2);
$AD_CODE['DISCUSSION_SEARCH'] = array('ID' => '9380500365', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['COMPETE'] = array('ID' => '4970075454', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 2);
$AD_CODE['ENTRY_TOP'] = array('ID' => '6961972124', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['ENTRY_BOTTOM'] = array('ID' => '4367439118', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['DISCUSSION_THREAD'] = array('ID' => '2390349546', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 2);
$AD_CODE['LEADERBOARD'] = array('ID' => '4367439118', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 4);
$AD_CODE['VOTE'] = array('ID' => '0213158278', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['DISCUSS_TOP'] = array('ID' => '7285139231', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['DISCUSS_BOTTOM'] = array('ID' => '9244123796', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['DISCUSSION_BOARD'] = array('ID' => '2220442700', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['THEMES'] = array('ID' => '9174213952', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
$AD_CODE['COMMUNITIES'] = array('ID' => '2661524115', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 6);
$AD_CODE['MEMBERS'] = array('ID' => '6285330368', 'WIDTH' => 728, 'HEIGHT' => 90, 'PROBABILITY' => 1);
...
$PICTURE_PATH = 'http://kirby.inspi.re/';
...
$PRIZE_BLACKLIST = array('59', '1583', '120489', '393', '44473');

$PAYPAL_API_SERVER = 'https://api-3t.sandbox.paypal.com/nvp';
$PAYPAL_API_USERNAME = 'coupon_1238085693_biz_api1.inspi.re';
$PAYPAL_API_PASSWORD = '4B65KT9SDURNWP3W';
$PAYPAL_API_SIGNATURE = 'AbyZqsomFULDfLFmzdnhcCSJE38GA8RHmDb9W6Q41vCxZzOqSleyAFSr';
